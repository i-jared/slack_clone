...
CREATE INDEX "direct_messages_dm_room_id_idx" ON "public"."direct_messages" USING "btree" ("dm_room_id");
...
CREATE INDEX "idx_direct_messages_thread_id" ON "public"."direct_messages" USING "btree" ("thread_id");
...
ALTER TABLE ONLY "public"."direct_messages"
    ADD CONSTRAINT "fk_direct_messages_workspace" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."message_reactions"
    ADD CONSTRAINT "fk_message_reactions_workspace" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."messages"
    ADD CONSTRAINT "fk_messages_workspace" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;
...
CREATE POLICY "Allow individual read access" ON "public"."user_roles" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Allow individual update" ON "public"."users" FOR UPDATE TO "authenticated" USING (("id" = "auth"."uid"())) WITH CHECK (("id" = "auth"."uid"()));



CREATE POLICY "Allow signup insert" ON "public"."users" FOR INSERT TO "authenticated", "anon" WITH CHECK (((("auth"."role"() = 'anon'::"text") AND ("id" = "auth"."uid"())) OR (("auth"."role"() = 'authenticated'::"text") AND ("id" = "auth"."uid"()))));
...
CREATE POLICY "Delete own message" ON "public"."messages" FOR DELETE TO "authenticated" USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Delete self" ON "public"."users" FOR DELETE TO "authenticated" USING (("id" = "auth"."uid"()));
...
CREATE POLICY "Insert message if user is sender" ON "public"."messages" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Insert your own user row" ON "public"."users" FOR INSERT TO "authenticated" WITH CHECK (("id" = "auth"."uid"()));
...
CREATE POLICY "Select all channel messages" ON "public"."messages" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Update own message" ON "public"."messages" FOR UPDATE TO "authenticated" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Update self" ON "public"."users" FOR UPDATE TO "authenticated" USING (("id" = "auth"."uid"())) WITH CHECK (("id" = "auth"."uid"()));
...
CREATE POLICY "Users can insert messages in their DM rooms" ON "public"."direct_messages" FOR INSERT WITH CHECK (((EXISTS ( SELECT 1
   FROM "public"."dm_room_members"
  WHERE (("dm_room_members"."dm_room_id" = "direct_messages"."dm_room_id") AND ("dm_room_members"."user_id" = "auth"."uid"())))) AND ("sender_id" = "auth"."uid"())));



CREATE POLICY "Users can view messages in their DM rooms" ON "public"."direct_messages" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."dm_room_members"
  WHERE (("dm_room_members"."dm_room_id" = "direct_messages"."dm_room_id") AND ("dm_room_members"."user_id" = "auth"."uid"())))));
